...
public class DataHandleServiceImpl implements DataHandleService {
     ...
     * @param reqId
     */
    private void createStdLegalMidTable(String reqId) {
        ...
        for(StdLegalDataStructured stdLegalDataStructured : stdLegalDataStructuredList) {
            ...
            if (CalculatUtil.equals(pTypes3, pType)) {
                ...
                caseMap = ideQuotasReadDao.getvarname(paraMap);
            ...
            Map<String, Object> mappayment = ideQuotasReadDao.getvarname(paraMap);
            if (mappayment != null) {
